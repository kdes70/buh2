...
--
-- Хост: 127.0.0.1
-- Время создания: Дек 20 2015 г., 14:54
...
CREATE TABLE `db1_categoryexp` (
  ...
  `path` varchar(1000) NOT NULL COMMENT 'Путь',
...
INSERT INTO `db1_categoryexp` (`id`, `parent_id`, `path`, `name`) VALUES
(0, 0, '', ''),
(60, 0, '0.60', 'Продукты питания'),
(61, 0, '0.61', 'Хоз. расходы'),
(62, 0, '0.62', 'Услуги связи'),
(63, 0, '0.63', 'Развлечения'),
(72, 0, '0.72', 'Гигиена'),
(77, 0, '0.77', 'Здоровье'),
(82, 0, '0.82', 'Коммунальные услуги'),
(83, 60, '0.60.83', 'Хлеб'),
(84, 60, '0.60.84', 'Овощи'),
(85, 83, '0.60.83.85', 'Булки'),
(89, 62, '0.62.89', 'Интернет'),
(90, 72, '0.72.90', 'Зубная паста'),
(91, 72, '0.72.91', 'Шампунь'),
(92, 72, '0.72.92', 'Мыло'),
(93, 72, '0.72.93', 'Зубная шетка'),
(94, 0, '0.94', 'Транспорт'),
(95, 94, '0.94.95', 'Такси'),
(96, 94, '0.94.96', 'Маршрутка'),
(97, 94, '0.94.97', 'Железная дорога'),
(98, 60, '0.60.98', 'Мясные продукты'),
(99, 60, '0.60.99', 'Рыбные продукты'),
(103, 62, '0.62.103', 'Мобильная связь'),
(104, 62, '0.62.104', 'Телефон'),
(108, 61, '0.61.108', 'Дача'),
(109, 94, '0.94.109', 'Нерегулярн. перевоз.'),
(110, 82, '0.82.110', 'Газ'),
(111, 82, '0.82.111', 'Электроэнергия'),
(112, 82, '0.82.112', 'Вода'),
(113, 82, '0.82.113', 'Мусор'),
(114, 77, '0.77.114', 'Лекарства'),
(116, 60, '0.60.116', 'Молокопродукты'),
(119, 77, '0.77.119', 'Услуги врача'),
(120, 108, '0.61.108.120', 'Удобрения'),
(122, 63, '0.63.122', 'Мотоцикл'),
(140, 103, '0.62.103.140', 'Yezzz'),
(141, 103, '0.62.103.141', 'МТС'),
(142, 108, '0.61.108.142', 'Инструмент'),
(143, 72, '0.72.143', 'Дезодорант'),
(144, 72, '0.72.144', 'Прокладки'),
(145, 116, '0.60.116.145', 'Молоко'),
(146, 116, '0.60.116.146', 'Сметана'),
(147, 116, '0.60.116.147', 'Кефир'),
(148, 116, '0.60.116.148', 'Ряженка'),
(149, 116, '0.60.116.149', 'Йогурт'),
(150, 116, '0.60.116.150', 'Сыр твердый'),
(151, 116, '0.60.116.151', 'Сыр плавленый'),
(152, 83, '0.60.83.152', 'Хлеб белый'),
(153, 83, '0.60.83.153', 'Хлеб черный'),
(154, 98, '0.60.98.154', 'Мясо говяжье'),
(155, 98, '0.60.98.155', 'Мясо свинное'),
(156, 98, '0.60.98.156', 'Колбаса копченая'),
(157, 98, '0.60.98.157', 'Колбаса вареная'),
(158, 99, '0.60.99.158', 'Рыба свежая'),
(159, 99, '0.60.99.159', 'Рыба копченая'),
(160, 84, '0.60.84.160', 'Лук'),
(161, 84, '0.60.84.161', 'Картошка');
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Уникальность кода валюты за дату';
...
(27, '2015-12-19', 'USD', 100, '2354.641400');
...
(58, '10.00', 2, '1000.00', 160, '', '2015-12-20', 2, 1),
(59, '20.00', 1, '1.00', 161, '', '2015-12-20', 2, 3);
...
(44, '10.00', 1, '0.00', 99, 'Хек', 2, 3, 'Рыбные продукты');
...
(1, 'Карточка FidoBank', '1787.50', 0, 2),
(2, 'Карточка Приват', '0.00', 1, 2),
(3, 'Наличные', '2043.88', 0, 2),
